                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          (widget.pet.cost != null && widget.pet.cost! > 0)
                              ? '\$${widget.pet.cost!.toStringAsFixed(0)}'
                              : 'Free',
                          style:
            ...
            child: ElevatedButton(
              onPressed: widget.pet.isAdopted
                  ...
                  : () async {
                      ...
                      // Adopt the pet
                      await context.read<DetailsCubit>().adoptPet(widget.pet);

                      // Show confetti
                      _confettiController.play();

                      // Show adoption success dialog
                      if (mounted) {
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              Text(
                'Thank you for giving ${widget.pet.name} a loving home.',
                textAlign: TextAlign.center,
